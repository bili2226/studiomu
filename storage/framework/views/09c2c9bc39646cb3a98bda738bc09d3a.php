...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Studio.mu</title>
...
<body class="antialiased font-sans" style="height:100vh; display:flex; overflow:hidden;">
        ...
        <div class="auth-left-content">
            ...
            <div>
                <a href="/" class="inline-flex items-center group">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Studio.mu"
            ...
            <p class="text-[10px] font-semibold text-slate-500 uppercase tracking-widest">
                &copy; <?php echo e(date('Y')); ?> Studio.mu Visual Art
            </p>
    ...
    <div class="auth-right">
        ...
        <div class="lg:hidden flex items-center justify-between px-6 pt-5 pb-3 border-b border-white flex-shrink-0">
            <a href="/"><img src="<?php echo e(asset('img/logo.png')); ?>" alt="Studio.mu" class="h-7 w-auto"></a>
...
<?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/layouts/auth.blade.php ENDPATH**/ ?>