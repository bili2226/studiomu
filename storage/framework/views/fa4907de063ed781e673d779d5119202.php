<?php $__env->startSection('title', 'Reservasi Sesi Foto'); ?>

<?php $__env->startSection('sidebar'); ?>
    <a href="<?php echo e(url('/menu-utama')); ?>" class="sidebar-item sidebar-item-active flex items-center px-5 py-3.5 transition-all text-white">
    ...
    <a href="<?php echo e(route('customer.history')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008ZM0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z"/>
        </svg>
        <span>Riwayat Booking</span>
    </a>
    <a href="<?php echo e(url('/menu-utama')); ?>#gallery-card" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"/>
        </svg>
        <span>Galeri Foto</span>
    </a>
    <a href="<?php echo e(route('customer.loyalty')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
        ...
        <div class="bg-white border-2 border-black rounded-[2rem] shadow-2xl w-full max-w-4xl overflow-hidden relative z-10 flex flex-col my-4">
            ...
            <div class="p-8 sm:p-10 bg-slate-900 border-b-[2.5px] border-amber-400">
                <nav class="text-xs font-semibold text-slate-400 mb-3 flex items-center gap-1.5 font-sans tracking-wide">
                    <a href="<?php echo e(url('/menu-utama')); ?>" class="hover:text-amber-400 transition-colors font-semibold text-slate-400">Dashboard</a>
            ...
            <div class="p-8 sm:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5 space-y-6">
                    ...
                    <div class="bg-slate-50 border border-slate-300 rounded-2xl p-5 space-y-4 shadow-sm text-slate-800">
                        ...
                        <a href="<?php echo e($mapLinkUrl); ?>" target="_blank" class="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-slate-300 hover:border-slate-400 hover:bg-slate-50 text-slate-700 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm cursor-pointer">
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between items-center mb-2.5">
                            ...
                            <span class="inline-flex items-center px-2.5 py-1 bg-amber-50 text-amber-800 text-[9px] font-black uppercase tracking-wider rounded-lg border border-amber-200 shadow-sm">
                                Poin Anda: <?php echo e($userPoints); ?> pts
                            </span>
                        </div>
                        <div class="relative bg-white border border-primary-300 rounded-2xl p-1 focus-within:border-primary-500/40 focus-within:ring-4 focus-within:ring-primary-500/5 transition-all shadow-sm">
                            <select id="booking-reward" onchange="calculatePointsDiscount()" class="w-full bg-transparent px-4 py-3 text-xs font-semibold focus:outline-none text-slate-800 cursor-pointer relative z-10">
                                ...
                                <?php $__currentLoopData = $rewards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <option value="<?php echo e($reward->id); ?>" 
                                            data-discount="<?php echo e($reward->discount_amount); ?>" 
                                            data-points="<?php echo e($reward->points_required); ?>"
                                            <?php echo e(!$canRedeem ? 'disabled' : ''); ?>>
                                        <?php echo e($reward->name); ?> (Butuh <?php echo e($reward->points_required); ?> Poin) - <?php echo e($canRedeem ? 'Tersedia' : 'Poin Tidak Cukup'); ?>
            ...
            <div class="p-8 sm:p-10 border-t-[2.5px] border-amber-400 flex flex-col sm:flex-row gap-4 justify-end bg-slate-900">
                <a href="<?php echo e(url('/menu-utama')); ?>" class="w-full sm:w-auto px-8 py-3.5 border border-slate-600 hover:border-slate-500 hover:bg-slate-800 text-slate-300 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all text-center flex items-center justify-center">
                    Batal
                </a>
...
<script>
    ...
    const dbServices = <?php echo json_encode($services, 15, 512) ?>;
    ...
    const timeSlots = <?php echo json_encode($timeSlots, 15, 512) ?>;
    const holidays = <?php echo json_encode($holidays, 15, 512) ?>;
    const serviceKey = "<?php echo e($serviceKey); ?>";
                ...
                if (data.snap_token) {
                    ...
                    window.snap.pay(data.snap_token, {
                        ...
                        onPending: function(result) {
                            window.location.href = `<?php echo e(route('customer.history')); ?>?unpaid=1&pending_id=${data.booking.id}`;
                        },
                    ...
                    if (parseInt(data.booking.amount) === 0 || data.booking.status === 'Confirmed') {
                        ...
                        window.location.href = `<?php echo e(route('customer.history')); ?>?free_success=1&pending_id=${data.booking.id}`;
                    } else if (data.booking.payment_method === 'Cash') {
                        // Redirect for Cash booking
                        window.location.href = `<?php echo e(route('customer.history')); ?>?cash_success=1&pending_id=${data.booking.id}`;
                    } else {
                        alert(data.message || 'Booking berhasil dibuat.');
                        window.location.href = `<?php echo e(route('customer.history')); ?>`;
                    }
                } else {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/customer/booking.blade.php ENDPATH**/ ?>