<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="smooth-scroll">
<head>
    <meta charset="utf-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
            ...
            <div class="flex justify-between h-16 items-center glass-card px-6 rounded-2xl shadow-sm relative">
                ...
                <a href="#" class="flex items-center group">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Studio.mu Logo" class="h-8 md:h-10 w-auto transition-transform duration-300 group-hover:scale-110">
                </a>
                ...
                <div class="flex items-center space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route(Auth::user()->role . '.dashboard')); ?>" class="bg-primary-950 text-white px-6 sm:px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary-800 transition-all shadow-lg shadow-primary-950/20">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="hidden sm:block border-2 border-slate-300 hover:border-primary-950 hover:text-primary-950 text-slate-700 px-6 sm:px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">Masuk</a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-primary-950 text-white px-6 sm:px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary-800 transition-all shadow-lg shadow-primary-950/20">
                            Daftar
                        </a>
                    <?php endif; ?>
            ...
            <div class="peer-checked:block hidden lg:hidden mt-3 glass-card rounded-2xl p-6 shadow-xl border border-slate-100/50 animate-fade-in-up">
                <div class="flex flex-col space-y-4 text-[11px] font-extrabold uppercase tracking-[0.2em] text-slate-600">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-center border-2 border-slate-300 hover:border-primary-950 hover:text-primary-950 text-slate-700 py-3 rounded-xl transition-all font-black uppercase tracking-widest mt-2">Masuk</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div class="animate-fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="bg-primary-950 text-white px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-primary-800 transition-all shadow-xl shadow-primary-950/20 text-center">
                        Mulai Sekarang
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
                <div class="col-span-1 lg:col-span-1">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Studio.mu Logo" class="h-12 w-auto mb-8">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center text-white border-2 border-white/20 px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-slate-950 hover:border-white transition-all">
                        Login Dashboard
                    </a>
                </div>
            </div>
            <div class="pt-12 border-t border-white/20 flex flex-col md:flex-row justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-slate-600">
                <p>&copy; <?php echo e(date('Y')); ?> Studio.mu Visual Art. All rights reserved.</p>
...
<?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/welcome.blade.php ENDPATH**/ ?>