<?php $__env->startSection('title', 'Ulasan Evaluasi Sesi'); ?>

<?php $__env->startSection('sidebar'); ?>
    <a href="<?php echo e(url('/photographer/jadwal')); ?>" class="sidebar-item flex items-center px-6 py-4 rounded-2xl mx-2 text-slate-500 hover:text-slate-900 transition-all">
    ...
    <a href="<?php echo e(route('photographer.reviews')); ?>" class="sidebar-item sidebar-item-active flex items-center px-6 py-4 rounded-2xl mx-2 mt-2">
                    ...
                    <tbody class="font-semibold text-slate-800">
                        ...
                        <tr class="group hover:bg-slate-50/60 transition-colors border-b border-black last:border-0">
                            ...
                            <td class="py-4 pr-4 align-top">
                                ...
                                <p class="text-[10px] font-bold uppercase tracking-wider mt-1 text-slate-500">Klien: <span class="text-slate-800"><?php echo e($review->user->name ?? 'User Terhapus'); ?></span></p>
                            </td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/photographer/reviews.blade.php ENDPATH**/ ?>