...
<?php $__env->startSection('sidebar'); ?>
    ...
    <?php elseif(Auth::user()->role === 'photographer'): ?>
        <a href="<?php echo e(route('photographer.dashboard')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-black hover:text-black transition-all font-bold">
        ...
        <a href="<?php echo e(route('photographer.reviews')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-black hover:text-black transition-all font-bold mt-2">
...
<form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" class="bg-white border-2 border-black rounded-[2rem] shadow-[0_12px_40px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col mb-12 animate-fade-in-up">
    <?php echo csrf_field(); ?>
        ...
        <div class="flex flex-col items-center gap-4 md:w-1/3">
            <div class="relative w-32 h-32 rounded-full border-4 border-slate-100 shadow-md overflow-hidden bg-slate-50 group">
                <?php if($user->avatar_url): ?>
                    <img src="<?php echo e($user->avatar_url); ?>" alt="Profile Photo" class="w-full h-full object-cover" id="avatarPreview">
                <?php else: ?>
        ...
        <div class="flex-1 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="Contoh: 08123456789"
                           class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold focus:ring-2 focus:ring-amber-400 focus:border-amber-400 outline-none transition-all">
                </div>
            </div>

            <?php if(in_array($user->role, ['admin', 'photographer'])): ?>
            <div>
                ...
                <textarea name="bio" rows="4" placeholder="Ceritakan sedikit tentang diri atau pengalaman Anda..."
                          class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold focus:ring-2 focus:ring-amber-400 focus:border-amber-400 outline-none transition-all resize-none"><?php echo e(old('bio', $user->bio)); ?></textarea>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/profile/edit.blade.php ENDPATH**/ ?>