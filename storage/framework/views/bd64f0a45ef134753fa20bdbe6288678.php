<?php $__env->startSection('title', 'Poin Loyalitas'); ?>

<?php $__env->startSection('sidebar'); ?>
    <a href="<?php echo e(url('/menu-utama')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all font-bold">
    ...
    <a href="<?php echo e(route('customer.history')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all font-bold">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008ZM0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z"/>
        </svg>
        <span>Riwayat Booking</span>
    </a>
    <a href="<?php echo e(route('customer.gallery')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all font-bold">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"/>
        </svg>
        <span>Galeri Foto</span>
    </a>
    <a href="<?php echo e(route('customer.loyalty')); ?>" class="sidebar-item sidebar-item-active flex items-center px-5 py-3.5 transition-all text-white font-black">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
        ...
        <div class="lg:col-span-5 bg-white border border-primary-300 rounded-[2.2rem] p-8 shadow-md flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
                <div class="flex justify-between items-center mb-6">
                    ...
                    <span class="px-3 py-1 bg-gradient-to-r <?php echo e($tierColor); ?> text-white text-[8px] font-black uppercase tracking-widest rounded shadow-sm"><?php echo e($tier); ?></span>
                </div>
                <div class="flex items-baseline gap-1">
                    <h3 class="text-6xl font-serif italic font-bold text-slate-900"><?php echo e(number_format($points)); ?></h3>
            ...
            <div class="mt-8">
                <div class="flex justify-between text-[9px] font-black uppercase tracking-wider text-slate-500 mb-2">
                    <span><?php echo e($pct); ?>% Menuju Free Booking Target</span>
                    <span class="text-primary-600 font-black"><?php echo e($remaining); ?> Pts Lagi</span>
                </div>
                <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden border border-slate-200">
                    <div class="bg-gradient-to-r from-primary-500 to-[#0c4a6e] h-full rounded-full" style="width: <?php echo e($pct); ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-7 bg-white border border-primary-300 rounded-[2.2rem] p-8 shadow-md flex flex-col justify-between">
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <!-- Bronze -->
                    <div class="p-4 rounded-2xl border <?php echo e($points < 150 ? 'border-primary-500 bg-primary-50/20' : 'border-slate-100 bg-slate-50/50'); ?> flex flex-col justify-between">
                        <div>
                    ...
                    <!-- Silver -->
                    <div class="p-4 rounded-2xl border <?php echo e(($points >= 150 && $points < 400) ? 'border-primary-500 bg-primary-50/20' : 'border-slate-100 bg-slate-50/50'); ?> flex flex-col justify-between">
                        <div>
                    ...
                    <!-- Gold -->
                    <div class="p-4 rounded-2xl border <?php echo e($points >= 400 ? 'border-primary-500 bg-primary-50/20' : 'border-slate-100 bg-slate-50/50'); ?> flex flex-col justify-between">
                        <div>
                    ...
                    <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex items-start justify-between gap-4 p-3.5 bg-emerald-50/20 border border-emerald-100 rounded-2xl transition-all hover:bg-emerald-50/45">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[9px] text-slate-400 uppercase tracking-widest mt-0.5"><?php echo e($booking->booking_date->format('d M Y')); ?> • ID: <?php echo e($booking->id); ?></p>
                                        <p class="text-[10px] text-slate-500 font-semibold mt-1">Sesi: <?php echo e($booking->service_name); ?></p>
                                    </div>
                                </div>
                                <span class="text-emerald-700 font-black text-xs flex-shrink-0 font-sans">+<?php echo e($booking->points_earned); ?> pts</span>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($booking->points_used > 0): ?>
                            <div class="flex items-start justify-between gap-4 p-3.5 bg-amber-50/20 border border-amber-100 rounded-2xl transition-all hover:bg-amber-50/45">
                                ...
                                <span class="text-amber-700 font-black text-xs flex-shrink-0 font-sans">-<?php echo e($booking->points_used); ?> pts</span>
                            </div>
                        <?php endif; ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $rewards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-white border border-primary-300 rounded-[1.8rem] p-5 hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between group">
                        ...
                        <div>
                            <div class="flex justify-between items-start mb-4.5">
                                <span class="inline-flex items-center px-2.5 py-1 bg-amber-50 text-amber-800 text-[8px] font-black uppercase tracking-wider rounded border border-amber-100 shadow-sm">
                                    <?php echo e($reward->points_required); ?> Pts
                                </span>
                                <?php if($canClaim): ?>
                            ...
                            <h5 class="text-[13px] font-black text-slate-900 leading-snug uppercase tracking-wide group-hover:text-primary-700 transition-colors"><?php echo e($reward->name); ?></h5>
                            <p class="text-[10px] text-slate-500 font-semibold leading-relaxed mt-1.5"><?php echo e($reward->description ?: 'Tukarkan poin loyalitas Anda untuk memotong biaya sesi booking foto Anda.'); ?></p>
                        </div>
                        <div class="mt-6 pt-3.5 border-t border-slate-100 flex justify-between items-baseline">
                            ...
                            <span class="text-lg font-black text-amber-800 font-sans">Rp <?php echo e(number_format($reward->discount_amount, 0, ',', '.')); ?></span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/customer/loyalty.blade.php ENDPATH**/ ?>