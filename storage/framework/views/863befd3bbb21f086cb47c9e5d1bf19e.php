...
<?php $__env->startSection('sidebar'); ?>
    ...
    <a href="<?php echo e(route('customer.gallery')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
    ...
    <a href="<?php echo e(route('customer.reviews')); ?>" class="sidebar-item flex items-center px-5 py-3.5 text-slate-500 hover:text-slate-900 transition-all">
        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
    ...
    <div class="bg-gradient-to-br from-primary-950 via-[#0c4a6e] to-primary-950 text-white p-8 sm:p-12 border border-white/10 rounded-[2rem] shadow-2xl mb-10 relative overflow-hidden animate-fade-in-up">
        ...
        <div class="relative z-10 w-full">
            ...
            <h3 class="text-3xl sm:text-5xl font-serif italic font-bold tracking-tight mb-4 text-white">
                Halo, <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F59E0B] font-bold"><?php echo e(Auth::user()->name); ?></span>!
            </h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div id="loyalty-card" class="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-white p-7 rounded-[1.8rem] border border-white/10 flex flex-col justify-between shadow-xl hover:shadow-2xl hover:border-amber-500/30 hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden">
            ...
            <div>
                <div class="flex justify-between items-center mb-6">
                    ...
                    <span class="px-2.5 py-1 bg-gradient-to-r from-[#D4AF37] to-[#F59E0B] text-slate-950 text-[8px] font-black uppercase tracking-widest rounded border-none shadow-md"><?php echo e($tier); ?></span>
                </div>
                <h3 class="text-5xl font-serif italic font-bold text-white">
                    <?php echo e($points); ?> <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F59E0B] text-xs font-sans font-black uppercase tracking-widest ml-1">pts</span>
                </h3>
            </div>
            <div class="mt-8">
                <div class="flex justify-between text-[9px] font-black uppercase tracking-wider text-slate-350 mb-2">
                    <span><?php echo e($pct); ?>% Menuju Free Booking</span>
                    <span class="text-[#D4AF37] font-extrabold"><?php echo e($remaining); ?> Poin Lagi</span>
                </div>
                <div class="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden mb-4">
                    <div class="bg-gradient-to-r from-[#D4AF37] to-[#F59E0B] h-full rounded-full" style="width: <?php echo e($pct); ?>%"></div>
                </div>
                <a href="<?php echo e(route('customer.loyalty')); ?>" class="text-[#D4AF37] hover:text-[#F59E0B] text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 transition-colors group">
        ...
        <div id="booking-card" class="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-white p-7 rounded-[1.8rem] border border-white/10 flex flex-col justify-between shadow-xl hover:shadow-2xl hover:border-primary-500/30 hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group">
            ...
            <div class="mt-8 relative z-10 flex flex-col gap-1.5">
                ...
                <a href="<?php echo e($mapLinkUrl ?? 'https://maps.google.com/?q=-6.227561,106.812239'); ?>" target="_blank" class="text-primary-400 hover:text-primary-300 text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 transition-colors group w-fit">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>