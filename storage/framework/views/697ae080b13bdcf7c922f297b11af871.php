<?php $__env->startSection('title', 'Kelola Operasional & Lokasi'); ?>
            ...
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="location-form-link" value="<?php echo e($mapLinkUrl); ?>" placeholder="Contoh: https://maps.google.com/?q=..." class="w-full bg-slate-50 border border-slate-200 focus:border-amber-600 focus:ring-4 focus:ring-amber-500/10 rounded-2xl px-4 py-3.5 text-xs font-semibold focus:outline-none text-slate-900 transition-all duration-300 shadow-sm">
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-6 admin-card-blue bg-white border border-slate-200 rounded-[2rem] shadow-xl shadow-slate-100/50 overflow-hidden flex flex-col" style="border-left: 2px solid #111827 !important; border-right: 2px solid #111827 !important;">
            ...
            <div class="flex-grow flex flex-col justify-between bg-slate-50 border-t border-slate-100 p-6">
                ...
                <div class="mb-4">
                    ...
                    <p id="preview-map-address" class="text-xs font-semibold text-slate-800 leading-relaxed"><?php echo e($mapAddress); ?></p>
                </div>
                
                <!-- Google Maps Iframe -->
                <div class="w-full h-40 bg-slate-200 rounded-xl overflow-hidden relative border border-slate-200 mb-4 shadow-sm">
                    <iframe id="preview-map-iframe" src="<?php echo e($mapIframeUrl); ?>" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>

                <!-- Google Maps Link Button -->
                <a id="preview-map-link" href="<?php echo e($mapLinkUrl); ?>" target="_blank" class="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-slate-300 hover:border-slate-400 hover:bg-slate-50 text-slate-700 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm cursor-pointer">
...
<script>
    ...
    let timeSlots = <?php echo json_encode($timeSlots, 15, 512) ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asus\Documents\kuliah\smt 8\sistem informasi studio.mu\studio\resources\views/admin/holidays/index.blade.php ENDPATH**/ ?>