...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if ($user->role === 'admin') {
                ...
                return redirect()->intended('/photographer/jadwal');
            } else {
                return redirect()->intended('/menu-utama');
            }
        }
    ...
    public function register(Request $request)
    {
        ...
        $user = User::create([
            ...
            'role' => 'customer', // Default registration is for customers
        ]);
        ...
        try {
            ...
            // Log the error but do not disrupt registration flow
