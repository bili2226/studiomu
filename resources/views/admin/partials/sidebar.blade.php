...
<a href="{{ route('admin.reviews.index') }}" class="sidebar-item {{ $isReviews ? 'sidebar-item-active text-white' : 'text-slate-700 hover:text-slate-900' }} flex items-center w-full px-5 py-3.5 transition-all text-left font-sans text-xs uppercase tracking-[0.18em] font-black mt-1">
    <svg class="w-4 h-4 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
...
<a href="{{ route('admin.refunds.index') }}" class="sidebar-item {{ $isRefunds ? 'sidebar-item-active text-white' : 'text-slate-700 hover:text-slate-900' }} flex items-center w-full px-5 py-3.5 transition-all text-left font-sans text-xs uppercase tracking-[0.18em] font-black mt-1">
    <svg class="w-4 h-4 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
    ...
    @if($pendingRefundsCount > 0)
        <span class="ml-auto bg-rose-500 text-white text-[9px] font-black px-1.5 py-0.5 rounded-full min-w-[18px] text-center">{{ $pendingRefundsCount }}</span>
    @endif
</a>
