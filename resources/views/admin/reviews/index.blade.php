                        ...
                        <tr class="group hover:bg-slate-50/60 transition-colors border-b border-black last:border-0">
                            ...
                            <td class="py-4 pr-4 align-top">
                                ...
                                <div class="mt-2 flex items-center gap-2">
                                    ...
                                    <div>
                                        <p class="font-bold text-slate-700 text-[11px] leading-snug">{{ $review->user->name ?? 'User Terhapus' }}</p>
                                        <p class="text-[9px] text-slate-400 tracking-wide">{{ $review->user->email ?? '' }}</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            {{-- Fotografer --}}
                            <td class="py-4 pr-4 align-top">
                                <p class="font-bold text-slate-900 text-[11px]">{{ $review->photographer->name ?? 'Belum Ditugaskan' }}</p>
                            </td>
