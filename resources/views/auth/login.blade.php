        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-5 relative z-10">
            ...
            <div>
                <div class="flex justify-between items-center mb-2">
                    ...
                    <a href="{{ route('password.request') }}" class="text-[10px] font-black text-amber-700 hover:text-amber-800 transition-colors uppercase tracking-wide">
                        Lupa Sandi?
                    </a>
                </div>
                <div class="relative">
            ...
            {{-- Submit Button (primary, gold accent) --}}
            <button type="submit"
